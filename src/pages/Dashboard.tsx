...
export default function Dashboard() {
    ...
    return (
        <>
            ...
            {/* Features - Consolidated into 4 categories */}
            <Card className="shadow-strong">
                <CardHeader className="pb-3">
                ...
                <CardContent className="space-y-4">
                    {/* Analytics & Insights */}
                    <div>
                        <p className="text-sm font-semibold text-muted-foreground mb-2">📊 Analytics & Insights</p>
                        <div className="grid grid-cols-3 gap-2">
                            ...
                            >
                                ...
                                <span className="text-[10px] text-blue-600 font-medium">+ PDF Export</span>
                            </Button>
                            <Button
                                variant="outline"
                    ...
                    {/* Meal Management */}
                    <div>
                        <p className="text-sm font-semibold text-muted-foreground mb-2">🍽️ Meal Management</p>
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            >
                                ...
                                <span className="text-xs">Meal Templates</span>
                            </Button>
                            <Button
                                variant="outline"
                            ...
                            <Button
                                variant="outline"
                                onClick={() => navigate('/recipe-gallery')}
                                className="h-20 flex flex-col gap-1"
                            >
                                <ChefHat className="w-5 h-5 text-red-500" />
                                <span className="text-xs">Recipe Gallery</span>
                                <span className="text-[10px] text-pink-600 font-medium">Community</span>
                            </Button>
                        </div>
                    </div>
                    ...
                    <div>
                        <p className="text-sm font-semibold text-muted-foreground mb-2">⚙️ Integrations & Smart Tools</p>
                        <div className="grid grid-cols-3 gap-2">
                            <Button
                                variant="outline"
                                onClick={() => navigate('/fitbit')}
                                className="h-20 flex flex-col gap-1 border-purple-200 hover:border-purple-400"
                            >
                                <Activity className="w-5 h-5 text-purple-600" />
                                <span className="text-xs">Fitbit</span>
                                <span className="text-[10px] text-purple-600 font-medium">New</span>
                            </Button>
                            <Button
                                variant="outline"
